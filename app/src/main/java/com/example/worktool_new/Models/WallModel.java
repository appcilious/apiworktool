...
public class WallModel {
    ...
    public class Datum {
        ...
        @SerializedName("commentcivilite")
        @Expose
        private String commentcivilite;
        @SerializedName("commentdate")
        @Expose
        private String commentdate;
        @SerializedName("commentemail")
        @Expose
        private String commentemail;
        @SerializedName("commentimage")
        @Expose
        private String commentimage;
        @SerializedName("commentnom")
        @Expose
        private String commentnom;
        @SerializedName("commentprenom")
        @Expose
        private String commentprenom;
        @SerializedName("cp")
        @Expose
        private String cp;
        ...
        @SerializedName("email_postuler")
        @Expose
        private String emailPostuler;
        ...
        @SerializedName("titre_postuler")
        @Expose
        private String titrePostuler;
        @SerializedName("type")
        @Expose
        private String type;
        ...
        public void setIdComment(String idComment2) {
            this.idComment = idComment2;
        }
        ...
        public void setCommentdate(String commentdate2) {
            this.commentdate = commentdate2;
        }

        public String getCommentcivilite() {
            return this.commentcivilite;
        }

        public void setCommentcivilite(String commentcivilite2) {
            this.commentcivilite = commentcivilite2;
        }

        public String getCommentnom() {
            return this.commentnom;
        }

        public void setCommentnom(String commentnom2) {
            this.commentnom = commentnom2;
        }

        public String getCommentprenom() {
            return this.commentprenom;
        }

        public void setCommentprenom(String commentprenom2) {
            this.commentprenom = commentprenom2;
        }
        ...
        public void setCommentemail(String commentemail2) {
            this.commentemail = commentemail2;
        }
        ...
        public void setCommentimage(String commentimage2) {
            this.commentimage = commentimage2;
        }
        ...
        public String getEmailPostuler() {
            return this.emailPostuler;
        }

        public void setEmailPostuler(String emailPostuler2) {
            this.emailPostuler = emailPostuler2;
        }

        public String getTitrePostuler() {
            return this.titrePostuler;
        }

        public void setTitrePostuler(String titrePostuler2) {
            this.titrePostuler = titrePostuler2;
        }
        ...
        public void setFile(Object file2) {
            this.file = file2;
        }
